    ...
    return (
      <div id="projects" className="personal_projects_container">
        ...
        <div className="personal_projects_header_container">
          <p className="personal_projects_header">Other Project Work</p>
          <p className="personal_projects_header-sub">Here are a few of our client driven projects.</p>
        </div>
          ...
          <div className="card">
            ...
            <div className="card-container">
              <div className="card-content-wrapper">
                ...
                <p className="card-content">APiO is a Utah based FinTech company that leverages Big Data, Blockchain, AI and Machine Learning to transform how capital is accessed and invested. We created mockups based on user stories and other provided graphics.</p>
          ...
          <div className="card">
            ...
            <div className="card-container">
              <div className="card-content-wrapper">
                ...
                <p className="card-content">Unboxt is a company endeavoring to connect the job seeker to businesses around the world. We created mockup designs from wireframes representing dashboards and profile pages and improved upon their landing page.</p>
                <div className="no-view-project-button"></div>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="card-container">
              <div className="card-content-wrapper">
                ...
                <p className="card-content">Crypto Elevation is a Global Cryptocurrency organization that helps people all around the world create wealth and give back. We added several sections and pages to their site and created uniformity with modern design.</p>
          ...
          <div className="card">
            ...
            <div id="devTest" className="card-container">
              <div className="card-content-wrapper">
                ...
                <p className="card-content">Isaac Lowder is currently a music educator located in the greater Salt Lake area. He's promoting his business and came to us for a logo and business card design.</p>
          ...
          <div className="card">
            ...
            <div id="devTest" className="card-container">
              <div className="card-content-wrapper">
                ...
                <p className="card-content">PPL is the creator of 'family servers', small, plug-and-play cloud servers designed to plug into your home router and used to save and share files from any device. Our role was to design the landing page and other custom illustrations.</p>
          ...
          <div className="card">
            ...
            <div id="devTest" className="card-container">
              <div className="card-content-wrapper">
                ...
                <p className="card-content">Coinless connects car washes with customer phones for a game-changing business solution. Our involvement included WordPress theme implementation, icon design, layout design and custom CSS.</p>
          ...
          <div className="card">
            ...
            <div id="devTest" className="card-container">
              <div className="card-content-wrapper">
                ...
                <p className="card-content">Reza Ahmadi acts as Principal for his organization, Emergent Solutions. We were hired to design the digital signage for his presentation on Designing Culture: Building a Foundation for Performance in 90 Days.</p>
